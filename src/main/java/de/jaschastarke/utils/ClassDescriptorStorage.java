...
public final class ClassDescriptorStorage {
    ...
    public void store(final File file) {
        ...
        for (Entry<String, ClassDescription> cls : descriptions.entrySet()) {
    ...
    public String toString() {
        String str = "";
        for (Entry<String, ClassDescription> entry : descriptions.entrySet()) {
    ...
    public class ClassDescription {
        ...
        public String toString() {
            String str = name + ":\n";
            for (Entry<String, DocComment> el : elComments.entrySet()) {
